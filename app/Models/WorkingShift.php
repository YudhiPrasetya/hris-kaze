 ...
 * @file   WorkingShift.php
 * @date   2021-11-24 22:39:21
 */
...
class WorkingShift extends ModelBase {
	...
	public function __construct(array $attributes = []) {
		...
		$this->setTable(table('master.working_shifts', onlyName: true));

		parent::__construct($attributes);
	}

	public function employees(): HasMany {
		return $this->hasMany(Employee::class, 'working_shift_id', 'id');
	}
}