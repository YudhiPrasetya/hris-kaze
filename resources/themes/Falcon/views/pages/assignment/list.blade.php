...
@section('columns')
	...
	<th scope="col" data-class="va-baseline" data-field="destination.name" data-sortable="true">Destination</th>
	<th scope="col" data-class="va-baseline text-center" data-field="is_chargeable" data-sortable="true">Chargeable</th>
	<th scope="col" data-class="va-baseline text-center" data-field="total_worker" data-sortable="true">Total Technicians
	</th>
