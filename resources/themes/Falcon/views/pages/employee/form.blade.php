		...
		<x-bootstrap::column breakpoint="EXTRA_SMALL|12;MEDIUM|9">
			<x-bootstrap::card>
				...
				<x-bootstrap::card.body class="bg-light">
					<x-bootstrap::row>
						<x-bootstrap::column breakpoint="EXTRA_SMALL;MEDIUM|3"
							class="d-flex align-items-start justify-content-center border-right">
						...
						<x-bootstrap::column breakpoint="EXTRA_SMALL;MEDIUM|9" class="pb-6">
							...
							{{-- {!! form_row($form->leave_allowance, ['attr' => ['value' =>
							$fields->get('leave_allowance')]]) !!} --}}
						</x-bootstrap::column>
					</x-bootstrap::row>
					<x-bootstrap::row>
						<x-bootstrap::column breakpoint="EXTRA_SMALL|3" class="border-right">
							<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
								aria-orientation="vertical" data-spy="affix" data-prefix="nav" data-offset-top="665"
								data-target=".os-viewport">
								<a class="nav-link active" id="v-pills-info-tab" data-toggle="pill" href="#v-pills-info"
									role="tab" aria-controls="v-pills-info" aria-selected="true">Info</a>
								<a class="nav-link" id="v-pills-salary-tab" data-toggle="pill" href="#v-pills-salary"
									role="tab" aria-controls="v-pills-salary" aria-selected="true">Salary</a>
							</div>
						</x-bootstrap::column>
						<x-bootstrap::column breakpoint="EXTRA_SMALL|9" class="background-transparent">
							<div class="tab-content" id="v-pills-tabContent">
								<div class="tab-pane fade show active" id="v-pills-info" role="tabpanel"
									...
									<x-bootstrap::media variant="primary" class="mb-4" icon="fad fa-info"
										title="Personal Information" subtitle="Employee personal information." />
								...
								<div class="tab-pane fade" id="v-pills-salary" role="tabpanel"
									...
									<x-bootstrap::row>
										<x-bootstrap::column breakpoint="MEDIUM|6">
											<x-bootstrap::media variant="primary" class="mb-4" icon="fad fa-money-check-alt"
										...
										<x-bootstrap::column breakpoint="MEDIUM|6">
											<x-bootstrap::media variant="primary" class="mb-4" icon="fad fa-info"
												title="Allowance" subtitle="Salary allowance based on position." />
